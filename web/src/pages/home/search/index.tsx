    ...
    <div>
      <KobalteSearch
        ...
        sectionComponent={(props) => {
          ...
          return (
            <KobalteSearch.Section class="px-3 py-1 text-xs text-neutral-light font-semibold uppercase">
              {name}
            </KobalteSearch.Section>
          );
        }}
      >
        ...
        >
          <KobalteSearch.Indicator
            loadingComponent={
              <KobalteSearch.Icon class="flex-center pl-2">
                <svg
          ...
          <KobalteSearch.Input class="w-full border-none focus:ring-0 outline-none py-2" />
        </KobalteSearch.Control>

        <KobalteSearch.Portal>
          <KobalteSearch.Content class="bg-white rounded-md shadow-md border border-border-strong mt-1 py-1 max-h-[300px] overflow-y-auto z-50">
            <KobalteSearch.Listbox />
            <KobalteSearch.NoResult class="px-3 py-2 text-sm text-neutral-light">
              No results found
