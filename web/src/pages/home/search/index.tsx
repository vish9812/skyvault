...
function Search() {
  ...
  const [showSearch, setShowSearch] = createSignal(false); // for mobile
  ...
  return (
    <div>
      {/* Mobile: show search icon, then bar when toggled */}
      <div class="md:hidden">
        <Show
          when={!showSearch()}
          fallback={
        ...
        >
          ...
          <button
            type="button"
            class="flex items-center justify-center p-2 rounded-full border border-border bg-white shadow transition hover:bg-bg-muted"
