  ...
  return (
    <>
      ...
      <div class="md:hidden fixed bottom-0 inset-x-0 bg-white border-t border-border z-10">
        <nav class="flex items-center justify-around link-no-underline">
          <A href="/">
            <div
              class={`m-1 py-2 px-2 rounded-full ${
                activeMenu() === "home" ? "bg-primary-light/30" : ""
              }`}
          ...
          <A href="/shared" onClick={() => setActiveMenu("shared")}>
            <div
              class={`m-1 py-2 px-2 rounded-full ${
                activeMenu() === "shared" ? "bg-primary-light/30" : ""
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <CreateUpload />
          <A href="/favorites" onClick={() => setActiveMenu("favorites")}>
            <div
              class={`m-1 py-2 px-2 rounded-full ${
                activeMenu() === "favorites" ? "bg-primary-light/30" : ""
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <A href="/trash" onClick={() => setActiveMenu("trash")}>
            <div
              class={`m-1 py-2 px-2 rounded-full ${
                activeMenu() === "trash" ? "bg-primary-light/30" : ""
              }`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
