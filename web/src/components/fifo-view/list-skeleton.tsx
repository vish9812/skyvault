function ListSkeleton() {
  return (
    <div class="border border-border rounded-lg overflow-hidden max-w-screen-xl mx-auto">
      {/* Header */}
      <div class="grid grid-cols-[2rem_1fr_6rem_9rem_2rem] items-center py-3 px-3 bg-bg-muted border-b border-border font-medium text-sm text-neutral-light">
        <div></div>
        <div>Name</div>
      ...
      {Array.from({ length: 7 }).map(() => (
        <div class="grid grid-cols-[2rem_1fr_6rem_9rem_2rem] items-center py-3 px-4 border-t border-border first:border-t-0">
